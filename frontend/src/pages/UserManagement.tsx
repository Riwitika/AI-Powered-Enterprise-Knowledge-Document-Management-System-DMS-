...
export default function UserManagement() {
  ...
  const initialUsers: UserRowItem[] = [
    ...
    },
    {
      id: 'usr-4',
      name: 'Amit Verma',
      email: 'amit.verma@fasttrade.com',
      initials: 'AV',
      department: 'Finance',
      role: 'employee',
      status: 'active',
    ...
    },
    {
      id: 'usr-5',
      name: 'Neha Gupta',
      email: 'neha.gupta@fasttrade.com',
      initials: 'NG',
    ...
    },
    {
      id: 'usr-6',
      name: 'Ritika Sharma',
      email: 'ritika.sharma@fasttrade.com',
      initials: 'RS',
      department: 'HR Operations',
      role: 'employee',
      status: 'pending',
      ...
      devices: [],
      securityStatus: 'Pending activation (2FA Not Setup)',
      avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150'
    },
    {
      id: 'usr-7',
      name: 'Rohit Sharma',
      email: 'rohit.sharma@fasttrade.com',
      initials: 'RS',
      department: 'Operations',
      role: 'employee',
      status: 'suspended',
      ...
      permissions: [],
      devices: [],
      securityStatus: 'Account Suspended by Admin',
      avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150'
    },
    {
      id: 'usr-8',
      name: 'Priya Mehta',
      email: 'priya.mehta@fasttrade.com',
      initials: 'PM',
      department: 'Sales & Marketing',
      role: 'viewer',
      status: 'inactive',
      lastLogin: '10 May 2024, 11:00 AM',
      phone: '+91 94433 22110',
      managerName: 'Riwitika Gupta',
      groups: ['Sales Team'],
      permissions: ['Read Workspace Documents'],
      devices: [],
      securityStatus: 'Inactive Session',
